...
namespace CleverCrow.Fluid.UniqueIds.UniqueIdRepairs {
    public class SceneSearch : ComponentBase {
        ...
        public SceneSearch (VisualElement container, ReportScene report, Action<ReportId> onFixId, bool includeInactiveObjects = false) : base (container) {
            ...
            report.Errors.ForEach((error) => {
                _errors.Add(new UniqueIdError(results, report, error, onFixId, includeInactiveObjects));
            });
        }
